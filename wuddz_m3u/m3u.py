...
class M3U:
    ...
    def __check(self, u: str, fd: str, d: bool=False):
        """
...
"Accept-Encoding": "gzip, deflate"
        ...
        res = requests.get(u, headers=hd, timeout=self.to, verify=False, stream=d)
        ...
        if args.create:self.__create(fa, self.cd, tt=args.title, ss=args.season, ep=args.episode, am=args.amount)
            ...
            with ThreadPoolExecutor(max_workers=args.threads) as exe:
                for m in ml:
                    ...
                    try:
                        c += 1
                        if args.legit:tl.append(exe.submit(self.__check, m, self.dd, d=args.download))
